...
import TallerWordPressImg from '@/assets/WORDPRESS-8.jpg'; // Asegúrate de tener esta imagen
...
const FormularioTallerWordPress: React.FC = () => {
  ...
  const verificarDisponibilidad = async (field: string, value: string) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/tallerwordpress/verificar-disponibilidad`, {
        method: 'POST',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: any = {
        ...
        actividades: ['taller-wordpress'] // ✅ Cambiado a taller-wordpress
      };
      ...
      const res = await fetch(`${API_URL}/tallerwordpress/registro`, { // ✅ Cambiado a tallerwordpress
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <>
      <div className="formulario-container">
        {/* Encabezado - MODIFICADO PARA TALLER DE WORDPRESS */}
        <div className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-8 relative mb-8 border">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-4">
              ...
              <span className="text-gray-600 font-medium">
                Sala 2 de Sistemas – Sede Pance
              </span>
            </div>

            <p className="text-gray-600 max-w-2xl mx-auto">
              Instalación de WordPress en entorno Linux (Ubuntu) mediante WSL en Windows
            </p>
          </div>
        </div>

        <form onSubmit={handleSubmit}>
          {/* Información del Evento - Versión Mejorada PARA TALLER DE WORDPRESS */}
          <div className="mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="relative">
                <img
                  ...
                  src={TallerWordPressImg}
                  alt="Taller de WordPress - XI Semana de la Ingeniería"
                />
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Instalación de WordPress en entorno Linux (Ubuntu)</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                  Un taller práctico donde aprenderás a instalar y configurar WordPress en un entorno 
                  Linux (Ubuntu) utilizando WSL en Windows, incluyendo la configuración de MySQL, Apache y PHP.
                </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Sala 2 de Sistemas<br />Sede Pance</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      <CodeIcon className="w-5 h-5 text-uniblue mt-0.5" />
                      <div>
                        <strong className="text-gray-700">Ponente:</strong>
                        <p className="text-gray-600">Mag. Carlos Molina</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export default FormularioTallerWordPress;