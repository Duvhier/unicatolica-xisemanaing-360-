...
const FormularioIndustriaAccion: React.FC = () => {
  ...
  const verificarDisponibilidad = async (field: string, value: string) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/industriaenaccion/verificar-disponibilidad`, {
        method: 'POST',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: any = {
        ...
        actividades: ['industria-en-accion'] // ✅ Cambiado a industria-en-accion
      };
      ...
      const res = await fetch(`${API_URL}/industriaenaccion/registro`, { // ✅ Cambiado a industriaenaccion
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <>
      <div className="formulario-container">
        {/* Encabezado - MODIFICADO PARA INDUSTRIA EN ACCIÓN */}
        <div className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-8 relative mb-8 border">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-4">
              ...
              <span className="text-gray-600 font-medium">
                Laboratotio de Ingeniería e Innovación – Sede Pance
              </span>
            </div>

            <p className="text-gray-600 max-w-2xl mx-auto">
              Espacio de Interacción entre Estudiantes y Empresas del Sector Industrial.
            </p>
          </div>
        </div>

        <form onSubmit={handleSubmit}>
          {/* Información del Evento - Versión Mejorada PARA INDUSTRIA EN ACCIÓN */}
          <div className="mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="relative">
                <img
                  ...
                  src={IndustriaImg}
                  alt="Industria en Acción XI Semana de la Ingeniería"
                />
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Industria en Acción</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                   Espacio de Interacción entre Estudiantes y Empresas del Sector Industrial para conocer Oportunidades Laborales y Proyectos de Innovación.
                </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Laboratotio de Ingeniería e Innovación<br />Sede Pance</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Encuentro Empresarial</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export default FormularioIndustriaAccion;