...
// Componentes de Iconos SVG (reutilizados del formulario inaugural)
...
const FormularioClausura: React.FC = () => {
  ...
  const verificarDisponibilidad = async (field: string, value: string) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/clausura/verificar-disponibilidad`, {
        method: 'POST',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/clausura/registro`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        ...
        <div className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-8 relative mb-8 border">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Ceremonia oficial de clausura de la XI Semana de la Ingeniería con entrega de reconocimientos
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="relative">
                <img
                  ...
                  src={ClausuraImg}
                  alt="Acto de Clausura XI Semana de la Ingeniería"
                />
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Acto de Clausura</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                  Ceremonia oficial de clausura de la XI Semana de la Ingeniería "360°: Innovación, Liderazgo y Futuro" con entrega de reconocimientos a participantes destacados y cierre oficial del evento.
                </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Entrega de reconocimientos y cierre oficial</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export default FormularioClausura;