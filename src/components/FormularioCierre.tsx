...
const FormularioCierreInaugural: React.FC = () => {
    ...
    return (
        <div className={`formulario-cierre-inaugural ${isMobile ? 'mobile-device' : ''}`}>
            {/* HEADER */}
                ...
                <div role="dialog" aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative bg-white rounded-3xl shadow-xl w-full max-w-md mx-4 p-10 text-center border border-gray-100">
                        ...
                        <p className="text-gray-500 mb-8 leading-relaxed">
                            Su asistencia al <span className="font-semibold text-gray-900">Cierre Inaugural</span> ha sido confirmada correctamente.
                        </p>
                        <button
                            type="button"
                            onClick={() => setSuccessOpen(false)}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-blue-700">
                                        Ya existe un registro con sus datos personales. Cada persona solo puede registrarse una vez para el cierre inaugural.
                                    </p>
                                </div>
                            </div>
                        </div>
